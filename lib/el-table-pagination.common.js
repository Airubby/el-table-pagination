...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "search-form-table", staticStyle: { position: "relative" } },
    [
      _vm.formOptions
        ? _c("el-table-form", {
            ref: "searchForm",
